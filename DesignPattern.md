...
**通信**：在C++设计模式语境中，**通信**指的是**对象之间交换信息、协调行为和共享数据的过程和机制**。信息其实就是所谓的操作，比如主角和配角进行通信，主角通过对讲机让配角帮他完成什么事，做什么其实就是信息。通信方式其实就是如何让配角知道要去做这件事。主角可以走到他面前告诉他也可以通过对讲机告诉他。
